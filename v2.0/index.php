...
$app->get('/category', 'authenticate', function () {
            ...
            if($result){
                ...
                if (strcmp($_SERVER['HTTP_HOST'], 'project-isdental-cammy92.c9users.io')  == 0 || strcmp($_SERVER['HTTP_HOST'], 'www.project-isdental-cammy92.c9users.io')  == 0){
                    $tmp['category_icon'] = siteURL()."api/images/v2.0/categories/".$company["ctgry_icon"];
                } else {
                    $tmp['category_icon'] = siteURL()."isdental/api/images/v2.0/categories/".$company["ctgry_icon"];
                }
...
$app->get('/home/featured', 'authenticate', function () {
            ...
            $banner_result = $db->getAllBanners();
...
$app->get('/cron', function () {
            ...
            if($speaker_result1){
                ...
                $response["favourites"] = array();
                while ($speaker = $speaker_result1->fetch_assoc()) {
                    $tmp = array();
                    $tmp['speaker_id'] = $speaker["spkr_id"];
                    $tmp['speaker_name'] = $speaker["spkr_name"];
                    $tmp['speaker_description'] = $speaker["spkr_description"];
                    ...
                    array_push($response["favourites"], $tmp);
                }
                $response["offers"] = array();
                while ($speaker = $speaker_result2->fetch_assoc()) {
                    $tmp = array();
                    $tmp['speaker_id'] = $speaker["spkr_id"];
                    $tmp['speaker_name'] = $speaker["spkr_name"];
                    $tmp['speaker_description'] = $speaker["spkr_description"];
                ...
                $response["enquiries"] = array();
                while ($speaker = $speaker_result3->fetch_assoc()) {
                    $tmp = array();
                    $tmp['speaker_id'] = $speaker["spkr_id"];
                    $tmp['speaker_name'] = $speaker["spkr_name"];
                    $tmp['speaker_description'] = $speaker["spkr_description"];
                    ...
                    array_push($response["enquiries"], $tmp);
                }
                    
                $response["html_privacy_policy"] = "<p style=\"font-family: myFont; font-size: 18px;\"><b>3M Espe Filtek Z250 XT My Kit</b></p> <p style=\"font-family: myFont; font-size: 18px;\">Offer : 1 Alginate Free</p> <p style=\"font-family: myFont; font-size: 18px;\"><a href=\"https://www.indiasupply.com/3m-espe-filtek-z250-xt-my-kit.html\">Buy</a></p>  <br>  <p>3M Espe Filtek Z350 XT My Kit</p> <p>Offer : 2 Alginate Free</p> <p style=\"font-family: myFont; font-size: 18px;\"><a href=\"https://www.indiasupply.com/3m-espe-offer-filtek-z350-xt-my-kit-2-alginate-impression-material-mint.html\">Buy</a></p>";
                $response["html_terms_of_use"] = "<pstyle=\"font-family: myFont;>3M Espe Filtek Z250 XT My Kit</p> <p>Offer : 1 Alginate Free</p> <p style=\"font-family: myFont; font-size: 18px;\"><a href=\"https://www.indiasupply.com/3m-espe-filtek-z250-xt-my-kit.html\">Buy</a></p>  <br>  <p>3M Espe Filtek Z350 XT My Kit</p> <p>Offer : 2 Alginate Free</p> <p style=\"font-family: myFont; font-size: 18px;\"><a href=\"https://www.indiasupply.com/3m-espe-offer-filtek-z350-xt-my-kit-2-alginate-impression-material-mint.html\">Buy</a></p>";
                $response["html_faqs"] = "<p>3M Espe Filtek Z250 XT My Kit</p> <p>Offer : 1 Alginate Free</p> <p style=\"font-family: myfont; font-size: 18px;\"><a href=\"https://www.indiasupply.com/3m-espe-filtek-z250-xt-my-kit.html\">Buy</a></p>  <br>  <p>3M Espe Filtek Z350 XT My Kit</p> <p>Offer : 2 Alginate Free</p> <p style=\"font-family: myfont; font-size: 18px;\"><a href=\"https://www.indiasupply.com/3m-espe-offer-filtek-z350-xt-my-kit-2-alginate-impression-material-mint.html\">Buy</a></p>";
                $response["html_help_and_support"] = "<p>3M Espe Filtek Z250 XT My Kit</p> <p>Offer : 1 Alginate Free</p> <p style=\"font-family: myfont; font-size: 18px;\"><a href=\"https://www.indiasupply.com/3m-espe-filtek-z250-xt-my-kit.html\">Buy</a></p>  <br>  <p>3M Espe Filtek Z350 XT My Kit</p> <p>Offer : 2 Alginate Free</p> <p style=\"font-family: myfont; font-size: 18px;\"><a href=\"https://www.indiasupply.com/3m-espe-offer-filtek-z350-xt-my-kit-2-alginate-impression-material-mint.html\">Buy</a></p>";
                echoResponse(200, $response);
            } else {
                $response["error"] = true;
                $response["message"] = "Failed to fetch Events";
